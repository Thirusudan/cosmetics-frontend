...
export default function AdminPage(){
    return(
        <div className="w-full h-screen  flex">  
            ...
            <Link className="flex flex-row h-[60px] w-full border p-[20px] items-center text-xl gap-[25px]" to="/admin/products"><FaBoxArchive />Product</Link> 
             ...
             <Link className="flex flex-row h-[60px] w-full border p-[20px] items-center text-xl gap-[25px]"  to="/admin/contact"><IoSettings />Contact</Link>
