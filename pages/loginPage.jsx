...
//2 - <input onChange={(e) => {
  ...
  // 4 -  navigate = a function that moves user  to different page WITHOUT refreshing the browser!
  //useNavigate = React's smooth page changer — moves user to different pages without refreshing the browser! 

  //after login success server sends back this token saved in browser
