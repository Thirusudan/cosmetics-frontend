...
export default function ProductCard(props){
    ...
    return(
       <Link to={"/overview/"+product.productId} className="min-w-[300px] h-[400px] flex flex-col shadow-2xl shrink-0 rounded-2xl overflow-hidden    group transition-all duration-300 hover:shadow-[0_20px_40px_rgba(0,0,0,0.2)] hover:-translate-y-2 "> 
